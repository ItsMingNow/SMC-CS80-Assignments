...
const audioPlayer = new AudioPlayer('.audioPlayer', [
    ...
    {url: 'songs/Enough_MixB.mp3', name: 'Enough'},
    {url: 'songs/interstate.mp3', name: 'Interstate'},
    {url: 'songs/This_bird.mp3', name: 'This Bird'},
    {url: 'songs/newTime.mp3', name: 'New Time'},
    {url: 'songs/seagulls.mp3', name: 'Seagulls'}
]);